                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInUp" data-delay=".6s">Votre hôpital <br> a domicile.</h1>
                                <P data-animation="fadeInUp" data-delay=".8s" >Accédez à n'inporte quel service de santé, à partir de chez dans le conform de votre salon.</P>
                                <!-- Hero-btn -->
                                <div class="hero__btn">
                                    <a href="industries.html" class="btn hero-btn mb-10"  data-animation="fadeInLeft" data-delay=".8s">Commender</a>
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10">
                            <div class="hero__caption">
                                ...
                                <!-- Hero-btn -->
                                <div class="hero__btn">
                                    <a href="industries.html" class="btn hero-btn mb-10"  data-animation="fadeInLeft" data-delay=".8s">Faire un  Don</a>
                                    <a href="industries.html" class="cal-btn ml-15" data-animation="fadeInRight" data-delay="1.0s">
                                        <i class="flaticon-null"></i>
                                        <p>+12 1325 41</p>
                                    </a>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div class="single-counter text-center">
                                ...
                                <p class="color-green">Patients</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <!-- Counter Up -->
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            ...
                            <div class="single-counter text-center">
                                ...
                                <span class="plus">+</span>
                                <p class="color-green">Hôpitaux</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <!-- Counter Up -->
                            <div class="single-counter text-center">
                                <span class="counter color-green">256</span>
                                <span class="plus">+</span>
                                <p class="color-green">Laboratoires</p>
                            </div>
                        </div>
                ...
                <div class="col-lg-2 col-md-3 col-sm-3">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            ...
                            <p>The sea freight timetting to know your processes to.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-3">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10 col-sm-10">
                    ...
                    <div class="section-tittle section-tittle2 text-center mb-70">
                        ...
                        <h2>Une équipe d'Expert à votre ecoute</h2>
                    </div>
                </div>
            </div>
            <div class="row">
